...
pub trait RFold {
    ...
    fn rfold_binop_bitxor(
        &mut self,
        t: (syn::token::Caret),
    ) -> Result<syn::BinOp, Self::Error> {
        rfold_binop_bitxor(self, t)
    }
    fn rfold_binop_bitand(
        &mut self,
        t: (syn::token::And),
    ) -> Result<syn::BinOp, Self::Error> {
        rfold_binop_bitand(self, t)
    }
    fn rfold_binop_bitor(
        &mut self,
        t: (syn::token::Or),
    ) -> Result<syn::BinOp, Self::Error> {
    ...
    fn rfold_expr_assign(
        &mut self,
        t: (syn::ExprAssign),
    ) -> Result<syn::Expr, Self::Error> {
        rfold_expr_assign(self, t)
    }
    fn rfold_expr_assignop(
        &mut self,
        t: (syn::ExprAssignOp),
    ) -> Result<syn::Expr, Self::Error> {
    ...
    fn rfold_expr_closure(
        &mut self,
        t: (syn::ExprClosure),
    ) -> Result<syn::Expr, Self::Error> {
        rfold_expr_closure(self, t)
    }
    fn rfold_expr_continue(
        &mut self,
        t: (syn::ExprContinue),
    ) -> Result<syn::Expr, Self::Error> {
    ...
    fn rfold_expr_reference(
        &mut self,
        t: (syn::ExprReference),
    ) -> Result<syn::Expr, Self::Error> {
        rfold_expr_reference(self, t)
    }
    fn rfold_expr_repeat(
        &mut self,
        t: (syn::ExprRepeat),
    ) -> Result<syn::Expr, Self::Error> {
        rfold_expr_repeat(self, t)
    }
    fn rfold_expr_return(
        &mut self,
        t: (syn::ExprReturn),
    ) -> Result<syn::Expr, Self::Error> {
        rfold_expr_return(self, t)
    }
    fn rfold_expr_struct(
        &mut self,
        t: (syn::ExprStruct),
    ) -> Result<syn::Expr, Self::Error> {
    ...
    fn rfold_exprtype(
        &mut self,
        t: syn::ExprType,
    ) -> Result<syn::ExprType, Self::Error> {
    ...
    fn rfold_item_static(
        &mut self,
        t: (syn::ItemStatic),
    ) -> Result<syn::Item, Self::Error> {
        rfold_item_static(self, t)
    }
    fn rfold_item_struct(
        &mut self,
        t: (syn::ItemStruct),
    ) -> Result<syn::Item, Self::Error> {
    ...
    fn rfold_itemmacro2(
        &mut self,
        t: syn::ItemMacro2,
    ) -> Result<syn::ItemMacro2, Self::Error> {
    ...
    fn rfold_lifetimedef(
        &mut self,
        t: syn::LifetimeDef,
    ) -> Result<syn::LifetimeDef, Self::Error> {
    ...
    fn rfold_nestedmeta(
        &mut self,
        t: syn::NestedMeta,
    ) -> Result<syn::NestedMeta, Self::Error> {
        rfold_nestedmeta(self, t)
    }
    fn rfold_nestedmeta_meta(
        &mut self,
        t: (syn::Meta),
    ) -> Result<syn::NestedMeta, Self::Error> {
        rfold_nestedmeta_meta(self, t)
    }
    fn rfold_nestedmeta_lit(
        &mut self,
        t: (syn::Lit),
    ) -> Result<syn::NestedMeta, Self::Error> {
    ...
    fn rfold_patmacro(
        &mut self,
        t: syn::PatMacro,
    ) -> Result<syn::PatMacro, Self::Error> {
    ...
    fn rfold_patrange(
        &mut self,
        t: syn::PatRange,
    ) -> Result<syn::PatRange, Self::Error> {
    ...
    fn rfold_pathsegment(
        &mut self,
        t: syn::PathSegment,
    ) -> Result<syn::PathSegment, Self::Error> {
        rfold_pathsegment(self, t)
    }
    fn rfold_predicateeq(
        &mut self,
        t: syn::PredicateEq,
    ) -> Result<syn::PredicateEq, Self::Error> {
    ...
    fn rfold_viscrate(
        &mut self,
        t: syn::VisCrate,
    ) -> Result<syn::VisCrate, Self::Error> {
        rfold_viscrate(self, t)
    }
    fn rfold_vispublic(
        &mut self,
        t: syn::VisPublic,
    ) -> Result<syn::VisPublic, Self::Error> {
...
pub fn rfold_binding<F>(
    f: &mut F,
    t: syn::Binding,
) -> Result<syn::Binding, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_block<F>(
    f: &mut F,
    t: syn::Block,
) -> Result<syn::Block, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_data_struct<F>(
    f: &mut F,
    t: (syn::DataStruct),
) -> Result<syn::Data, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
...
pub fn rfold_dataenum<F>(
    f: &mut F,
    t: syn::DataEnum,
) -> Result<syn::DataEnum, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprbox<F>(
    f: &mut F,
    t: syn::ExprBox,
) -> Result<syn::ExprBox, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprcall<F>(
    f: &mut F,
    t: syn::ExprCall,
) -> Result<syn::ExprCall, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprcast<F>(
    f: &mut F,
    t: syn::ExprCast,
) -> Result<syn::ExprCast, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprif<F>(
    f: &mut F,
    t: syn::ExprIf,
) -> Result<syn::ExprIf, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprlet<F>(
    f: &mut F,
    t: syn::ExprLet,
) -> Result<syn::ExprLet, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprlit<F>(
    f: &mut F,
    t: syn::ExprLit,
) -> Result<syn::ExprLit, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprloop<F>(
    f: &mut F,
    t: syn::ExprLoop,
) -> Result<syn::ExprLoop, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprpath<F>(
    f: &mut F,
    t: syn::ExprPath,
) -> Result<syn::ExprPath, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprtry<F>(
    f: &mut F,
    t: syn::ExprTry,
) -> Result<syn::ExprTry, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_exprtype<F>(
    f: &mut F,
    t: syn::ExprType,
) -> Result<syn::ExprType, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_field<F>(
    f: &mut F,
    t: syn::Field,
) -> Result<syn::Field, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_fieldpat<F>(
    f: &mut F,
    t: syn::FieldPat,
) -> Result<syn::FieldPat, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
    ...
    F: RFold + ?Sized,
{
    let t = match t {
        ...
        syn::GenericArgument::Constraint(tmp0) => {
            f.rfold_genericargument_constraint((tmp0))?
        }
...
{
    let t = match t {
        syn::GenericMethodArgument::Type(tmp0) => {
            f.rfold_genericmethodargument_type((tmp0))?
        }
        syn::GenericMethodArgument::Const(tmp0) => {
            f.rfold_genericmethodargument_const((tmp0))?
        }
        _ => t,
    };
    Ok(t)
...
pub fn rfold_generics<F>(
    f: &mut F,
    t: syn::Generics,
) -> Result<syn::Generics, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_index<F>(
    f: &mut F,
    t: syn::Index,
) -> Result<syn::Index, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemenum<F>(
    f: &mut F,
    t: syn::ItemEnum,
) -> Result<syn::ItemEnum, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemfn<F>(
    f: &mut F,
    t: syn::ItemFn,
) -> Result<syn::ItemFn, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemimpl<F>(
    f: &mut F,
    t: syn::ItemImpl,
) -> Result<syn::ItemImpl, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemmod<F>(
    f: &mut F,
    t: syn::ItemMod,
) -> Result<syn::ItemMod, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemtype<F>(
    f: &mut F,
    t: syn::ItemType,
) -> Result<syn::ItemType, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_itemuse<F>(
    f: &mut F,
    t: syn::ItemUse,
) -> Result<syn::ItemUse, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_label<F>(
    f: &mut F,
    t: syn::Label,
) -> Result<syn::Label, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_lifetime<F>(
    f: &mut F,
    t: syn::Lifetime,
) -> Result<syn::Lifetime, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_litbool<F>(
    f: &mut F,
    t: syn::LitBool,
) -> Result<syn::LitBool, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_litbyte<F>(
    f: &mut F,
    t: syn::LitByte,
) -> Result<syn::LitByte, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    Ok(t)
...
pub fn rfold_litchar<F>(
    f: &mut F,
    t: syn::LitChar,
) -> Result<syn::LitChar, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    Ok(t)
}
pub fn rfold_litfloat<F>(
    f: &mut F,
    t: syn::LitFloat,
) -> Result<syn::LitFloat, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    Ok(t)
}
pub fn rfold_litint<F>(
    f: &mut F,
    t: syn::LitInt,
) -> Result<syn::LitInt, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    Ok(t)
}
pub fn rfold_litstr<F>(
    f: &mut F,
    t: syn::LitStr,
) -> Result<syn::LitStr, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    Ok(t)
}
pub fn rfold_local<F>(
    f: &mut F,
    t: syn::Local,
) -> Result<syn::Local, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_macro<F>(
    f: &mut F,
    t: syn::Macro,
) -> Result<syn::Macro, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_metalist<F>(
    f: &mut F,
    t: syn::MetaList,
) -> Result<syn::MetaList, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patbox<F>(
    f: &mut F,
    t: syn::PatBox,
) -> Result<syn::PatBox, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patident<F>(
    f: &mut F,
    t: syn::PatIdent,
) -> Result<syn::PatIdent, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patlit<F>(
    f: &mut F,
    t: syn::PatLit,
) -> Result<syn::PatLit, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patmacro<F>(
    f: &mut F,
    t: syn::PatMacro,
) -> Result<syn::PatMacro, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_pator<F>(
    f: &mut F,
    t: syn::PatOr,
) -> Result<syn::PatOr, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patpath<F>(
    f: &mut F,
    t: syn::PatPath,
) -> Result<syn::PatPath, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patrange<F>(
    f: &mut F,
    t: syn::PatRange,
) -> Result<syn::PatRange, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patrest<F>(
    f: &mut F,
    t: syn::PatRest,
) -> Result<syn::PatRest, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patslice<F>(
    f: &mut F,
    t: syn::PatSlice,
) -> Result<syn::PatSlice, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_pattuple<F>(
    f: &mut F,
    t: syn::PatTuple,
) -> Result<syn::PatTuple, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_pattype<F>(
    f: &mut F,
    t: syn::PatType,
) -> Result<syn::PatType, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_patwild<F>(
    f: &mut F,
    t: syn::PatWild,
) -> Result<syn::PatWild, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
    ...
    F: RFold + ?Sized,
{
    let t = match t {
        syn::PathArguments::AngleBracketed(tmp0) => {
            f.rfold_patharguments_anglebracketed((tmp0))?
        }
        syn::PathArguments::Parenthesized(tmp0) => {
            f.rfold_patharguments_parenthesized((tmp0))?
        }
        _ => t,
    };
    Ok(t)
...
pub fn rfold_qself<F>(
    f: &mut F,
    t: syn::QSelf,
) -> Result<syn::QSelf, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_receiver<F>(
    f: &mut F,
    t: syn::Receiver,
) -> Result<syn::Receiver, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_typepath<F>(
    f: &mut F,
    t: syn::TypePath,
) -> Result<syn::TypePath, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_typeptr<F>(
    f: &mut F,
    t: syn::TypePtr,
) -> Result<syn::TypePtr, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_useglob<F>(
    f: &mut F,
    t: syn::UseGlob,
) -> Result<syn::UseGlob, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_usegroup<F>(
    f: &mut F,
    t: syn::UseGroup,
) -> Result<syn::UseGroup, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_usename<F>(
    f: &mut F,
    t: syn::UseName,
) -> Result<syn::UseName, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_usepath<F>(
    f: &mut F,
    t: syn::UsePath,
) -> Result<syn::UsePath, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_variadic<F>(
    f: &mut F,
    t: syn::Variadic,
) -> Result<syn::Variadic, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_variant<F>(
    f: &mut F,
    t: syn::Variant,
) -> Result<syn::Variant, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
...
pub fn rfold_viscrate<F>(
    f: &mut F,
    t: syn::VisCrate,
) -> Result<syn::VisCrate, <F as RFold>::Error>
where
    F: RFold + ?Sized,
{
    let mut t = t;
